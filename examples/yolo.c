...
{
    char *train_images = "/home/icat/GSH/darknet_mobilenet/my_scripts/infrared_train.txt";
    char *backup_directory = "/home/icat/GSH/darknet_mobilenet/backup/";
    srand(time(0));
...
void validate_yolo(char *cfgfile, char *weightfile)
{
    ...
    list *plist = get_paths("/home/icat/GSH/darknet_mobilenet/my_scripts/infrared_val.txt");
